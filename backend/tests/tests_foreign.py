...
class TestAnalyzer(unittest.TestCase):
    ...
    def test_text_22(self):
        self.assertEqual(
            TestAnalyzer.text_analyzer.start_foreign(
                ...
                "Вот что написала Ирена. В этом году я и мои друзья ездили в Крым, в Ялту. Эта поездка мне очень понравилась. "
                ...
                "Ботанический сад, были в музее А.П. Чехова, на заводе «Массандровские вина». Один раз мы ходили в горы. "
    ...
    def test_text_23(self):
        self.assertEqual(
            ...
            ['вдохновение', 'композитор', 'гений', 'музыка', 'труд', 'трудиться', 'спрашивать', 'талантливый', 'серьезно', 'писать'],
        )
