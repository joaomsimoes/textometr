...
export const DEMO_TEXT = 'Раннее утро. На кухне семьи биологов Пажетновых готовят завтрак… для пяти голодных медвежат! Сегодня в меню молоко с витаминами. Медвежат, которые остались без мамы, привозят Пажетновым с разных концов страны. Этих малышей нашли на лесозаготовке. Сильный шум в лесу часто выгоняет медведицу из берлоги. Обратно она уже никогда не вернется, поэтому единственный шанс медвежатам выжить — это получить помощь человека. Здесь важна каждая минута: если малыши сильно замерзнут, они могут заболеть пневмонией и умереть. Хорошо, что рабочие знали о Центре Пажетновых и сразу привезли их сюда.  За 30 лет Центр спасения медвежат-сирот вырастил и выпустил в природу более 200 молодых медведей, и каждого сотрудники помнят по имени. Поэтому друзья ласково называют основателя Центра Валентина Пажетнова "медвежий дедушка".'
